...
const ProductAddEditForm = ({handleSubmit,fetchProductDetails})=>{
    ...
    const {handleFileChange,handleImageRemove,setFormData,formData,variation,variationFormData,handleAddVariation,handleAttributeChange} = useContext(AddProductAdminContext)
