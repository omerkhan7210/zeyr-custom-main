...
const {email,password,handleSubmit,setPassword,setUsername,errorMessage} = useContext(LoginContextC)
  
  return (

    
    <form className={`${noClasses ? null : "d-flex justify-center flex-c align-center mauto w33"}  products-form products-form-login login`}  method="post" onSubmit={handleSubmit}>
